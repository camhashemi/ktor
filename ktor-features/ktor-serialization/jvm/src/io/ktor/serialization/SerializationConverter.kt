...
class SerializationConverter(private val json: Json) : ContentConverter {
    ...
    override suspend fun convertForSend(
        ...
        return TextContent(json.stringify(value), contentType.withCharset(context.call.suitableCharset()))
    }
